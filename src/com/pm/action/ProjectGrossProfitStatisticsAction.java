 ...
 */
@Controller
@RequestMapping(value = "ProjectGrossProfitStatisticsAction.do")
public class ProjectGrossProfitStatisticsAction extends BaseAction {
	
	
	private static String detailMethod = "queryGrossProfit1Detail";

	private static final String aciont = "ProjectGrossProfitStatisticsAction.do";
	private static final String urls = "gross_profit_urls";
	...
	@Autowired
	@Qualifier("grossProfitStatisticsServiceImpl") 
	private IGrossProfitStatisticsService grossProfitStatisticsService;
