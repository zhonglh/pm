...
public class OtherWorkAttendance implements Serializable , ISort{
	...
	@EntityAnnotation(item_name="部门名称" , item_sort=2,length=100)
	...
	public String getBusinessKey(){
		return this.getDept_id()+this.getAttendance_month()+this.getStaff_id();
	}
