...
public class ProjectStaffCost implements Serializable {
	
	private String project_staffcost_id;
	...
	public String getProject_staffcost_id() {
		return project_staffcost_id;
	}
	public void setProject_staffcost_id(String project_staffcost_id) {
		this.project_staffcost_id = project_staffcost_id;
	}
