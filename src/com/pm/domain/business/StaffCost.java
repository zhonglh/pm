...
public class StaffCost implements Serializable {
	...
	@EntityAnnotation(item_name="招聘专员名称", item_sort=6,length=60)
	...
	@EntityAnnotation(item_name="主管工号", item_sort=58,length=30)
	private String lead_no ;

	@EntityAnnotation(item_name="主管名称", item_sort=59)
	private String lead_name ;
	

	//报价和成本之间的差价
	@EntityAnnotation(item_name="差价", item_sort=62)
