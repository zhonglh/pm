...
public class ExcelProcessInsurance extends AbstractPMExcel<PersonnelMonthlyInsurance>{
	

	IPersonnelMonthlyInsuranceService service = null;

	public ExcelProcessInsurance(IApplyApproveService applyApproveService , IPersonnelMonthlyInsuranceService service) {
	...
	@Override
	public boolean checkPersonnelMonthly(PersonnelMonthlyInsurance base, StaffCost staffCost, Map<String,InsuranceGrade> insuranceGrades) {
		if(staffCost != null){
