...
public class ExcelProcessSalary extends AbstractPMExcel<PersonnelMonthlySalary> {
	

	IPersonnelMonthlySalaryService service = null;

	public ExcelProcessSalary(IApplyApproveService applyApproveService , IPersonnelMonthlySalaryService service) {
	...
	@Override
	public boolean checkPersonnelMonthly(PersonnelMonthlySalary base, StaffCost staffCost, Map<String,InsuranceGrade> insuranceGrades) {
