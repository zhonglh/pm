...
public interface IProjectExpendPayService extends IGeneralLogService , IBaseService {
	...
	@LogAnnotation(operation_type=LogConstant.OPERATION_INSERT,entity_type=LogConstant.ENTITY_PROJECT_EXPEND_PAY)
	public int addProjectExpendPay(ProjectExpendPay projectExpendpay) ;

	@LogAnnotation(operation_type=LogConstant.OPERATION_UPDATE,entity_type=LogConstant.ENTITY_PROJECT_EXPEND_PAY)
	public int updateProjectExpendPay(ProjectExpendPay projectExpendpay) ; 

	@LogAnnotation(operation_type=LogConstant.OPERATION_DELETE,entity_type=LogConstant.ENTITY_PROJECT_EXPEND_PAY)
	public void deleteProjectExpendPay(ProjectExpendPay[] projectExpendpays) ;

	@LogAnnotation(operation_type=LogConstant.OPERATION_CHECK,entity_type=LogConstant.ENTITY_PROJECT_EXPEND_PAY)
