...
public class GrossProfitStatisticsProject implements java.io.Serializable {
	...
	@EntityAnnotation(item_name="毛利润",item_sort=3)
	private double statistics_amount;
	

	@EntityAnnotation(item_name="毛利率(%)",item_sort=4)
	...
	@EntityAnnotation(item_name="信息来源",item_sort=6)
	private String info_sources_username;

	@EntityAnnotation(item_name="项目管理人",item_sort=7)
	private String manage_username;
	

	@EntityAnnotation(item_name="销售额归属",item_sort=8)
	private String sales_amount_deptname;	
	
	@EntityAnnotation(item_name="执行额归属",item_sort=9)
	private String exec_amount_deptname;
	

	@EntityAnnotation(item_name="所属部门",item_sort=10)
