...
public class NumberKit {
    ...
    public static double getNumberForBigDecimal(BigDecimal s, int decimal){
        BigDecimal s1 = s.setScale (decimal, BIGDECIMAL_ROUND);
        return s1.doubleValue ();
    }
    ...
    public static void main(String[] args){
        // BigDecimal s1 = new BigDecimal (1111127);
        // BigDecimal s2 = new BigDecimal (1000);
        // System.out.println (NumberKit.random (4));
    }
}
