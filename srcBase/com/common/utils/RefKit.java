...
public class RefKit {
    ...
    private static Logger logger = LoggerFactory.getLogger (RefKit.class);
     ...
     */
    @SuppressWarnings("rawtypes")
    public static String convertElementPropertyToString(Collection collection,String propertyName,final String separator){
