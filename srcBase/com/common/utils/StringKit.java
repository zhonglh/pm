...
public class StringKit {
    ...
    public static String getRealFilePath(String resourcePath){
        java.net.URL inputURL = StringKit.class.getResource (resourcePath);
        ...
        if (!isEmpty (filePath)) {
            ...
            if (!isEmpty (physicalFilePath)) {
                try {
                    ...
                    logger.error ("Unable to create directory " + filePath, e);
                }
            }
        }
    ...
    public static String getFileIcon(ServletContext application,String iconDirPath,String fileName){
        ...
        if (checkFileExists (application, filePath)) { return filePath; }
    ...
    public static String getPath(String resourceName){
        ...
        java.net.URL classUrl = new StringKit ().getClass ().getResource (resourceName);
    ...
    public static byte getByte(HttpServletRequest httpservletrequest,String s){
        if (httpservletrequest.getParameter (s) == null || httpservletrequest.getParameter (s).equals ("")) { return 0; }
    ...
    public static long getLong(HttpServletRequest httpservletrequest,String s){
        if (httpservletrequest.getParameter (s) == null || httpservletrequest.getParameter (s).equals ("")) { return 0L; }
