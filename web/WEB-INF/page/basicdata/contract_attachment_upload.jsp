...
<form action="${webroot }/ContractAttachmentAction.do?method=uploadProjectAttach" method="post" enctype="multipart/form-data" class="pageForm required-validate" onsubmit="return iframeCallback(this, $.bringBack)">
