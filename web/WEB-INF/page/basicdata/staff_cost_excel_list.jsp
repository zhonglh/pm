...
<div class="pageContent">		
		...
		<div class="pageFormContent" layoutH="56">	
			<table class="list nowrap" width="5300" >
				<thead>
					<tr>
				...
				<tbody>					
					...
					<tr>
						...
						<td>${staffcost.totalcost }</td>
						<td>${staffcost.firstquotes }</td>
						...
						<td>${staffcost.outsource_staff }</td>	
