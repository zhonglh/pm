...
<form id="pagerForm" method="post" action="${webroot }/StaffCostAction.do?method=queryAnalysisDetails">
	...
	<input type="hidden" name="staff_id" value="${param.staff_id}" />
...
<div class="pageContent">
	...
	<div class="panelBar">
		<ul class="toolBar">			
				<li><a class="icon" href="${webroot }/StaffCostAction.do?method=exportByAnalysisDetails" target="dwzExport" targetType="dialog" title="确定要导出这些记录吗?"><span>导出EXCEL</span></a></li>
		</ul>
	</div>
