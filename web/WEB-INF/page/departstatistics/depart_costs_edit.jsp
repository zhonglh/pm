...
<div class="pageContent">
	<form method="post" action="${webroot}/DepartCostsAction.do?method=${next_operation}" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
		<div class="pageFormContent" layoutH="56">
			...
			<p>
				<label>报销月份：</label>
				<input name="use_month" class="digits required month date" format="yyyyMM" minlength="6" maxlength="6" type="text" size="30" value="${departCosts1.use_month }" />
			</p>
			
			
			<p>
				<label>实际支付日期：</label>
				<input name="pay_date" class="date required"  type="text" size="30" value="<fmt:formatDate value="${departCosts1.pay_date }" pattern="yyyy-MM-dd"/>" />
			</p>
