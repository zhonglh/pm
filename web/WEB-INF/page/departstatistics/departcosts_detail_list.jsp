...
<form id="pagerForm" method="post" action="${webroot }/DepartStatisticsAction.do?method=queryDepartCostsDetail">
...
<div class="pageContent">
	...
	<div class="panelBar">
		<ul class="toolBar">			
				<li><a class="icon" href="${webroot }/DepartStatisticsAction.do?method=excelDepartCostsDetail" target="dwzExport" targetType="dialog" title="确定要导出这些记录吗?"><span>导出EXCEL</span></a></li>
		</ul>
	</div>
