...
<form id="pagerForm" method="post" action="${webroot }/StaffCostLeaveStatisticsAction.do?method=list">
...
<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return navTabSearch(this);" action="${webroot }/StaffCostLeaveStatisticsAction.do?method=list" method="post">
	<div class="searchBar">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="icon" href="${webroot}/StaffCostLeaveStatisticsAction.do?method=export" target="dwzExport" targetType="navTab" title="确定要导出这些记录吗?"><span>导出EXCEL</span></a></li>
		</ul>
	</div>
	<table class="table" width="1300" layoutH="136">
		...
		<tbody>
			...
			<tr target="staff_id" rel="${staffcost.staff_id }"  >
				...
				<td><fmt:formatDate value="${staffcost.leave_project_datetime }" pattern="yyyy-MM-dd"/></td>	
