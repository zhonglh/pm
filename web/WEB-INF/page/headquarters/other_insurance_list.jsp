...
<form id="pagerForm" method="post" action="${webroot }/OtherInsuranceAction.do?method=list">
	<input type="hidden" name="pageNum" value="${pageNum}" />
	<input type="hidden" name="numPerPage" value="${pageSize}" />
</form>
<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return navTabSearch(this);" action="${webroot }/OtherInsuranceAction.do?method=list" method="post">
	<div class="searchBar">
