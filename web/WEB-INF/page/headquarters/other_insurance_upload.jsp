...
<form action="${webroot }/OtherInsuranceAction.do?method=doExcel" method="post" enctype="multipart/form-data" class="pageForm required-validate" onsubmit="return iframeCallback(this, dailogDoneProcessError)">
