...
<div class="pageContent">
	<form method="post" action="${webroot}/OtherPersonnelMonthlySalaryAction.do?method=${next_operation}" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
		<div class="pageFormContent" layoutH="56">
			...
			<p>
				<label>部门名称：</label>
				<input name="dept_id"	type="hidden" value="${personnelMonthlySalary1.dept_id}"	 />
				<input name="dept_name" class="text" type="text" size="30" maxlength="60" value="${personnelMonthlySalary1.dept_name}" readonly="true" />
			</p>
