...
<div class="pageContent">
	<form method="post" action="${webroot }/OtherSalaryGroupAction.do?method=${next_operation}" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
		<div class="pageFormContent" layoutH="56">		
			...
			<table class="list nowrap itemUpdate salaryChangeComputer" id="salaryChangeComputer" width="6100" layoutH="165">
				<thead>
					<tr>
