...
<div class="pageContent">
	<form method="post" action="${webroot}/StaffPerformanceAction.do?method=verifyStaffPerformance" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
