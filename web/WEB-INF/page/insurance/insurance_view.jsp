...
<div class="pageContent">
	<form method="post" action="${webroot}/InsuranceAction.do?method=verifyInsurance" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
