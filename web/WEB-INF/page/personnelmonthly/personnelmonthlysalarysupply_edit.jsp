...
<div class="pageContent">
	<form method="post" action="${webroot}/PersonnelMonthlySalarySupplyAction.do?method=${next_operation}" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
		<div class="pageFormContent" layoutH="56">
			...
			<p>
				<label>项目名称：</label>
				<input name="project_id"	type="hidden" value="${personnelMonthlySalarySupply1.project_id}"	 />		
				<input name="project_name" class="text" type="text" size="30" maxlength="60" value="${personnelMonthlySalarySupply1.project_name}" readonly="true" />
			</p>
