...
<div class="pageContent">
	<form method="post" action="${webroot}/ProjectExpendAction.do?method=verifyProjectExpend" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
		<div class="pageFormContent" layoutH="56">
			...
			<p>
				<label>进项税额：</label>
				<fmt:formatNumber value="${projectExpend1.tax_deduction }" type="currency" pattern="###,###,##0.00"/>
			</p>

			<p>
				<label>实际成本：</label>
				<fmt:formatNumber value="${projectExpend1.actual_cost }" type="currency" pattern="###,###,##0.00"/>
			</p>
