...
<div class="pageContent">
	<form method="post" action="${webroot }/SalaryGroupAction.do?method=updateSalaryGroup4Datagrid" class="pageForm required-validate" onsubmit="return submitSalaryInfo(this, dialogAjaxDone);">
		<div class="pageFormContent" layoutH="56">		
			...
			<table class="list" id="salaryChangeComputer" height="100%" width="100%" layoutH="165">
				...
				<iframe src="${webroot}/SalaryGroupAction.do?method=toEdit4DG&id=${id}" id="salaryDetails" name="salaryDetails" style="width:100%;height:100%;" frameborder="no" border="0" marginwidth="0" marginheight="0"></iframe>
				</td></tr>
			</table>
...
function fullScreen(fullscreenButton){
	...
	try{
		...
		var url = "${webroot}/SalaryGroupAction.do?method=toEdit4DG&id=${id}&full";
		window.open(url);	
