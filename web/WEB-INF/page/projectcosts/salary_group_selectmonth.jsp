...
<div class="pageContent">
    ...
    <form method="post" action="${webroot }/SalaryGroupAction.do?method=autoAddSalaryGroup" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone)">
