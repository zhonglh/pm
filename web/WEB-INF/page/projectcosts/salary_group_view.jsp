...
<div class="pageContent">
	<form method="post" action="${webroot }/SalaryGroupAction.do?method=verifySalary" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
