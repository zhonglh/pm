...
<div class="pageContent">
	<form method="post" action="${webroot }/ReceivedPaymentAction.do?method=verifyReceivedPayment" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
