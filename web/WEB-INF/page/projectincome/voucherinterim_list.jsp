...
<div class="pageHeader">
	...
	<div class="searchBar">
		...
		<ul class="searchContent">		
			...
			<li>
				<label>凭证月份：</label>
				<input  type="text" class="digits date month"  autocomplete="off" size="7"   maxlength="6" minlength="6"  format="yyyyMM" name="months1" value="${param.months1}"/>
				<input  type="text" class="digits date month"  autocomplete="off" size="7"   maxlength="6" minlength="6"  format="yyyyMM" name="months2" value="${param.months2}"/>
			</li>
