...
<form id="pagerForm" method="post" action="${webroot }/${action }?method=allList">
	<input type="hidden" name="pageNum" value="${pageNum}" />
	<input type="hidden" name="numPerPage" value="${pageSize}" />
</form>

<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return navTabStaisticsSearch(this,${urls });" action="${webroot }/${action }?method=allList" method="post">
	<div class="searchBar">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="icon" href="${webroot }/${action }?method=exportAllList" target="dwzExport" targetType="navTab" title="实要导出所有记录吗?"><span>导出EXCEL</span></a></li>
		</ul>
	</div>
	<table class="table" width="480" layoutH="162">
		<thead>
			<tr>
				<th width="25">序号</th>
				<th width="250">项目名称</th>
				<th width="100">毛利润总计</th>	
				<th width="80">毛利率(%)</th>	
			</tr>
		</thead>
		<tbody>
