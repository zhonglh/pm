...
<form id="pagerForm" method="post" action="${webroot }/${action }?method=quarterList">
	<input type="hidden" name="pageNum" value="${pageNum}" />
	<input type="hidden" name="numPerPage" value="${pageSize}" />
</form>

<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return navTabStaisticsSearch(this,${urls });" action="${webroot }/${action }?method=quarterList" method="post">
	<div class="searchBar">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="icon" href="${webroot }/${action }?method=exportQuarterList" target="dwzExport" targetType="navTab" title="实要导出所有记录吗?"><span>导出EXCEL</span></a></li>
		</ul>
	</div>
