...
<form id="pagerForm" method="post" action="${webroot }/ProjectReceivablesStatisticsAction.do?method=deptList">
	<input type="hidden" name="pageNum" value="${pageNum}" />
	<input type="hidden" name="numPerPage" value="${pageSize}" />
</form>

<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return navTabStaisticsSearch(this,receivables_urls);" action="${webroot }/ProjectReceivablesStatisticsAction.do?method=deptList" method="post">
	<div class="searchBar">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="icon" href="${webroot }/ProjectReceivablesStatisticsAction.do?method=exportDeptList" target="dwzExport" targetType="navTab" title="实要导出所有记录吗?"><span>导出EXCEL</span></a></li>
		</ul>
	</div>
