...
<form id="pagerForm" method="post" action="${webroot }/ProjectSalesStatisticsAction.do?method=list">
	<input type="hidden" name="pageNum" value="${pageNum}" />
	<input type="hidden" name="numPerPage" value="${pageSize}" />
</form>

<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return navTabStaisticsSearch(this,sales_urls);" action="${webroot }/ProjectSalesStatisticsAction.do?method=list" method="post">
	<div class="searchBar">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="icon" href="${webroot }/ProjectSalesStatisticsAction.do?method=export" target="dwzExport" targetType="navTab" title="实要导出所有记录吗?"><span>导出EXCEL</span></a></li>
		</ul>
	</div>
		...
		<tbody>
			...
			<tr>
				...
				<td nowarp align="right">
					<a class="add" href="${webroot}/StatisticsDetailAction.do?method=querySalesDetail&project_id=${statistics.project_id }&month1=${param.month1}&month2=${param.month2}" mask="true" width="850" height="520" rel="detail" title="明细"  target="dialog">
					<b><u>				
