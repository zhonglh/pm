...
var navTab = {
	...
	openTab: function(tabid, url, options){ //if found tabid replace tab, else create a new tab.
		...
		if(options.firstCloseAll) {this.closeAllTab();}
		...
		if (iOpenIndex >= 0){
			...
			var tabFrag = '<li  id="#tabid#" tabid="#tabid#"><a href="javascript:" title="#title#" class="#tabid#"><span>#title#</span></a><a href="javascript:;" class="close">close</a></li>';
